...
| **Status** | Draft rev **03** (feature-complete; product-neutral examples) |
| **Protocol today** | 1.0 (stable wire contract) |
| **Target** | Protocol **1.1** (additive where practical) |
| **Created** | 2026-08-06 |
| **Revised** | 2026-08-06 (rev 03 — encoding rules; product-neutral examples) |
| **Implements** | **Nothing yet** — specification only; see implementation plan |
